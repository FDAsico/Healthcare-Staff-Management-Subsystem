...
export function validateCreateSchedule(req: Request, res: Response, next: NextFunction) {
  const { shiftDate, startTime, endTime } = req.body;
  if (!shiftDate) return res.status(400).json({ message: "Shift date is required" });
...
export function validateRecordAttendance(req: Request, res: Response, next: NextFunction) {
...
export function validateCreateLeave(req: Request, res: Response, next: NextFunction) {
...
export function validateReviewLeave(req: Request, res: Response, next: NextFunction) {
