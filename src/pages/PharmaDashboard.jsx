...
const InventoryTable = ({ data, onSearch }) => {
    ...
    // We remove the contentMargin and use standard flex behavior for better alignment
    ...
    return (
        <div className="flex min-h-screen bg-[#f9fafb]">
            ...
            <div
                ...
                style={{
                    marginLeft: `${sidebarWidth}px`, // Pushes content so it never hides behind sidebar
                ...
                <div className="bg-white border border-gray-200 rounded-lg p-6">
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <div className="flex gap-3 items-center">
                            ...
                            <select className="py-2 px-3 border border-[#e5e7eb] rounded-[8px] text-[0.85rem] text-[#ffff] bg-black cursor-pointer focus:outline-none">
